...
_DEFINITIONS = (
    ...
    _definition(
        ...
        "Retained PCA component count",
        "Minimal PCA component prefix meeting the frozen explained-variance threshold.",
        "count",
        "neutral",
        "fold",
        "fold index",
        "none",
        comparison_domain="fold_local_only",
    ),
    _definition(
        "pca_total_component_count",
        "Total PCA component count",
        "Number of input dimensions available to the fold-local PCA fit.",
        "count",
        "neutral",
        "fold",
        "fold index",
    ...
    _definition(
        ...
        "Retained cumulative explained variance",
        "Cumulative explained variance of the retained PCA prefix.",
        "fraction",
        "higher",
        "fold",
        "fold index",
    ...
    _definition(
        ...
        "PCA fit row count",
        "Complete raw TRAIN rows used by the fold-local PCA fit.",
        "count",
        "higher",
        "fold",
        "fold index",
    ...
    _definition(
        ...
        "PCA skipped incomplete row count",
        "Raw TRAIN rows excluded from the fold-local PCA fit for incompleteness.",
        "count",
        "lower",
        "fold",
        "fold index",
    ...
    _definition(
        ...
        "Raw-only OOS predictive log likelihood",
        "Matched raw-only baseline OOS predictive log likelihood per observation.",
        "log-likelihood / observation",
        "higher",
        "fold",
        "fold index",
        "none",
        comparison_domain="same_source_plan",
    ),
    _definition(
        "pca_comparison_augmented_oos_predictive_loglik_per_obs",
        "Raw-plus-PCA OOS predictive log likelihood",
        "Matched raw-plus-PCA OOS predictive log likelihood per observation.",
        "log-likelihood / observation",
        "higher",
        "fold",
        "fold index",
    ...
    _definition(
        "pca_comparison_delta_oos_predictive_loglik_per_obs",
        "Raw-plus-PCA OOS score delta",
        "Matched raw-plus-PCA minus raw-only OOS predictive log likelihood per observation.",
        "log-likelihood / observation",
        "higher",
        "fold",
        "fold index",
    ...
    _definition(
        ...
        "Mean raw-plus-PCA OOS score delta",
        "Mean matched raw-plus-PCA minus raw-only OOS predictive score delta.",
        "log-likelihood / observation",
        "higher",
        "candidate",
        "aggregate",
    ...
    _definition(
        ...
        "Raw-plus-PCA OOS win count",
        "Number of matched folds where raw-plus-PCA exceeds raw-only OOS score.",
        "count",
        "higher",
        "candidate",
        "aggregate",
...
_DYNAMIC_PATTERNS = tuple(
    ...
    for pattern in (
        ...
        r"pca_(?:loading_component_[0-9]+_feature_[0-9]+|explained_variance_ratio_component_[0-9]+)",
        ...
        r"k_score_(?:valid_fold_rate|forecast_score|calibration_score|stability_score|robustness_score|worst_fold_forecast_score|mean_support_score|complexity_penalty|total_score|eligible)_k[2-5]",
