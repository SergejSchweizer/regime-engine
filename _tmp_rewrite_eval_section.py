...
if idx < 0:
    raise SystemExit('section 18 marker not found')

section = r'''# 18. Xetra v3 three-regime-evaluation architecture — 2026-08-28
...
path.write_text(text[:idx] + section, encoding='utf-8')
